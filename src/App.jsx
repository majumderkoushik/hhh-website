...
function App() {
  ...
  return (
    ...
    <div>
      ...
      <p className="px-4 text-xs my-3 text-black">MESSAGE THERAPY</p>
    </div>
  ...
  <div className="border-b-4 border-gray-300 bg-gray-300">
    ...
    <p className="px-16 py-4 text-slate-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla</p>
    <p className="px-16 py-4 text-slate-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla</p>
  </div>
  <div className="px-80 m-4">
    <h1 className="text-2xl text-pink-800 text-center m-2">Family Wellness Message Therapy</h1>
    <p className="text-xs text-center px-40 m-2 text-slate-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt </p>
  </div>
  <footer className="bg-gray-300 p-3 mx-3 text-slate-500">
  <p className="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
  </footer>
  <p className="text-center text-slate-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, </p>
  </div>
    </>
  )
}
